...
import com.example.heartsound.Result_analysis.ResultDepartment_1;
...
public class LineChartData_1 {
    ResultDepartment_1 context;
    LineChart lineChart;

    public LineChartData_1(LineChart lineChart, ResultDepartment_1 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_1.MyYAxisValueFormatter());
    }
