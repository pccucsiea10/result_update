...
public class StartDepartment3_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.start_department3_4,container,false);
...
//        webView.setWebViewClient(new WebViewClient());
        ...
        webView.loadUrl("https://www.youtube.com/embed/F86WlwHxWLY");
...
//        });
        ...
        department_stop_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm.beginTransaction().replace(R.id.fragment_container,new StartDepartment4_4()).commit();
            }
        });
