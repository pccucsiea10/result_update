...
public class StartDepartment3_5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.start_department3_5,container,false);
...
//        webView.setWebViewClient(new WebViewClient());
        ...
        webView.loadUrl("https://www.youtube.com/embed/RVpoBWMmyoI");
...
//        });
        ...
        department_stop_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm.beginTransaction().replace(R.id.fragment_container,new StartDepartment4_5()).commit();
            }
        });
