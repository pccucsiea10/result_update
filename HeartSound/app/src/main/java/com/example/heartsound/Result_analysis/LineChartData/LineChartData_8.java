...
import com.example.heartsound.Result_analysis.ResultDepartment_8;
...
public class LineChartData_8 {
    ResultDepartment_8 context;
    LineChart lineChart;

    public LineChartData_8(LineChart lineChart, ResultDepartment_8 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_8.MyYAxisValueFormatter());
    }
