...
import com.example.heartsound.Result_analysis.ResultDepartment_7;
...
public class LineChartData_7 {
    ResultDepartment_7 context;
    LineChart lineChart;

    public LineChartData_7(LineChart lineChart, ResultDepartment_7 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_7.MyYAxisValueFormatter());
    }
