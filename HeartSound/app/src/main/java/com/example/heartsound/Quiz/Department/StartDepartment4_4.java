...
public class StartDepartment4_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.start_department4_4,container,false);
...
//                .add(R.id.fragment_container, StartDepartment3_2, "StartDepartment3_2").hide(StartDepartment3_2).commit();
        ...
        back_vedio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager fm = getActivity().getSupportFragmentManager();
                fm.beginTransaction().replace(R.id.fragment_container,new StartDepartment3_4()).addToBackStack(null).commit();
            }
        });
        return mainView;
    }
