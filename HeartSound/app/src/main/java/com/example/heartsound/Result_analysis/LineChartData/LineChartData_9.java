...
import com.example.heartsound.Result_analysis.ResultDepartment_9;
...
import com.example.heartsound.R;
public class LineChartData_9 {
    ResultDepartment_9 context;
    LineChart lineChart;

    public LineChartData_9(LineChart lineChart, ResultDepartment_9 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_9.MyYAxisValueFormatter());
    }
