...
import com.example.heartsound.Result_analysis.ResultDepartment_5;
...
public class LineChartData_5 {
    ResultDepartment_5 context;
    LineChart lineChart;

    public LineChartData_5(LineChart lineChart, ResultDepartment_5 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_5.MyYAxisValueFormatter());
    }
