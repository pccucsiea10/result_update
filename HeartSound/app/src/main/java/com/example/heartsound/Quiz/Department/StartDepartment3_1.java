...
public class StartDepartment3_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.start_department3_1,container,false);
...
//        webView.setWebViewClient(new WebViewClient());
        ...
        webView.loadUrl("https://www.youtube.com/embed/tjE8HRB5JCQ");
...
//        });
        ...
        department_stop_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm.beginTransaction().replace(R.id.fragment_container,new StartDepartment4_1()).commit();
            }
        });
