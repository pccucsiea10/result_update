...
public class StartDepartment3_9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.start_department3_9,container,false);
...
//        webView.setWebViewClient(new WebViewClient());
        ...
        webView.loadUrl("https://www.youtube.com/embed/CiIWUHBKZdo");
...
//        });
        ...
        department_stop_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm.beginTransaction().replace(R.id.fragment_container,new StartDepartment4_9()).commit();
