...
import com.example.heartsound.Result_analysis.ResultDepartment_2;
...
public class LineChartData_2 {
    ResultDepartment_2 context;
    LineChart lineChart;

    public LineChartData_2(LineChart lineChart, ResultDepartment_2 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_2.MyYAxisValueFormatter());
    }
