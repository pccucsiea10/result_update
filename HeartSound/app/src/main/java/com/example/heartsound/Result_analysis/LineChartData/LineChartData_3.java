...
import com.example.heartsound.Result_analysis.ResultDepartment_3;
...
public class LineChartData_3 {
    ResultDepartment_3 context;
    LineChart lineChart;

    public LineChartData_3(LineChart lineChart, ResultDepartment_3 context){
...
//                lineChart.setVisibleXRange(0,100);
    ...
    public void initY(Float min, Float max) {
        ...
        leftAxis.setValueFormatter(new LineChartData_3.MyYAxisValueFormatter());
    }
